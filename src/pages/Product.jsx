...
function Products() {
  ...
  const productData = useMemo (() => products.find((item) => item.id === Number (productId))
,[products, productId])
        ...
        <div className="flex-1  gap-2 sm:flex-row">
          ...
          <div className="flex-1 mt-5 sm:mt-0 ">
            ...
            <div className="flex justify-start gap-x-0.5 py-1 sm:py-2">
              ...
              <div>
               <span className="text-md text-gray-800 font-bold"> {currency}{productData.new_price} </span>
            </div>
            <div>
             ...
             {/* -------------------AddToCart-------------------------------- */}
             <button onClick={() => addToCart(productData.id,size)} className="border bg-black rounded-sm py-3 px-8 text-center ml-9 outline-none text-sm font-semibold text-white transition-all ease-in-out duration-300 hover:bg-pink-700 cursor-pointer">Add to Cart</button>
           ...
           {/* ------------------Description and Review-------------- */}
            <div className="mt-20">
               <div className="flex gap-1 text-gray-600">
                 ...
                 <p className="border px-5 py-3 text-sm rounded-sm">Reviews {productData.rating} </p>
               </div>
